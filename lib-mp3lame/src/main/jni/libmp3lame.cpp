...
Java_com_pglvee_lib_1mp3lame_LameUtil_initEncoder(JNIEnv *env,
...
extern "C" JNIEXPORT void JNICALL
Java_com_pglvee_lib_1mp3lame_LameUtil_destroyEncoder(
...
Java_com_pglvee_lib_1mp3lame_LameUtil_encodeFile(JNIEnv *env,
